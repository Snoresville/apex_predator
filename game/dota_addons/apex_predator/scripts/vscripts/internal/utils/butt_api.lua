...
function CDOTA_BaseNPC:AddNewModifierButt(caster, optionalSourceAbility, modifierName, modifierData)
	...
	if modifierName == "apex_strength" or modifierName == "apex_strength_base" then if caster:GetPrimaryAttribute() ~= 0 then return end end
	if modifierName == "apex_agility" or modifierName == "apex_agility_base" then if caster:GetPrimaryAttribute() ~= 1 then return end end
	if modifierName == "apex_intelligence" or modifierName == "apex_intelligence_base" then if caster:GetPrimaryAttribute() ~= 2 then return end end
	print(modifierName)
